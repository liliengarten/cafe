...
<template>
  <div class="modal">
    <form enctype="multipart/form-data" @submit.prevent class="modalWrapper">
      ...
      <div>
        <button @click="store.addWorkerVisibility()" class="cancel_button">
          Отмена
        </button>
        <button
          @click="store.addWorkerVisibility(), createEmployee()"
